...
public class MainActivity extends AppCompatActivity {
    Button buttonDLE, buttonAC, buttonEqual, button9, button8, button7, buttonPlus, button6,btnZero, button1, button2, button3, button4, button5,buttonInto, buttonMinus, buttonDivision,buttonDot;
    EditText edtxt;
